...
def display():
    ...
    maquinaria = Edificio(textures = textures, position=[10,2,-22], scale=5, txtIndex=7)
    ...
    hibrido = Edificio(textures = textures, position=[3,2,-10], scale=5, txtIndex=8)
    ...
    area_de_seleccion = Edificio(textures = textures, position=[38.5,4,-45], scale=5, txtIndex=2)
    ...
    zona1 = Edificio(textures = textures, position=[12.5,0,5], scale=4, txtIndex=0)
    ...
    zona2 = Edificio(textures = textures, position=[55,0,10], scale=4, txtIndex=0)
